...
public class Question5 {
    ...
    public static void main(String[] args) {
        Comparator<Customer> customerIdComparator=(customer1, customer2)-> -customer1.getCustomerId()- customer2.getCustomerId();
        ...
        bank.printAllCustomer(customerIdComparator);
